...
import { LayoutDashboard, Users, TicketPercent, ListCheck, List, Menu } from "lucide-react"
    ...
    items: [
      {
        ...
        children: [
          ...
          { title: "Options", href: "/dashboard/master-data/menu/options", roles: ["ADMIN", "OWNER"] },
        ],
      },
      {
        title: "Outlet",
